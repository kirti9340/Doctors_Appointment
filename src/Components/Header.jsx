...
const Header = () => {
  return (
    <div className='flex flex-col flex-wrap bg-blue-500 rounded-lg px-6 md:flex-row md:px-10 lg:px-20'>

        {/* ---------Left Side--------- */}
        <div className=' md:w-1/2 flex flex-col md:items-start items-center md:text-start text-center justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light md:text-start text-center'>
